...
const About = () => {
    const {ref, inView} = useInView({
        threshold: 0.5, triggerOnce: false,
    });

    return (<section id='about' className='section mb-16 h-screen mb-[500px]' ref={ref}>
        <div className='container mx-auto'>
            <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
                ...
                <motion.div
                    ...
                    <h3 className='h3 mb-4 atomic-age-regular'>"I'm a Freelance back-end Java developer with almost
                        5 years of
                        experience"</h3>
                    <p className='mb-6'>
                    ...
                    <div className="card">
                        <div className="header">
                            <div className="top">
                                ...
                                <div className="title">
                                    <p id="title2">about.txt</p>
                                </div>
                            </div>
                        </div>
                        <div className="code-container">
                                 <textarea readOnly="" name="code" id="code" className="area">
                                     He decided to become a Software Engineer in 2020. In 2022 he started as a
                    ...
                    {/*    stats*/}
                    {inView && (<div className=' flex gap-v-6 mr-3 lg:gap-x-10 mb-12'>
